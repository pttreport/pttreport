...
{
    public partial class history_2 : System.Web.UI.Page
    {
        CultureInfo ThCI = new System.Globalization.CultureInfo("th-TH");
        CultureInfo EngCI = new System.Globalization.CultureInfo("en-US");
        history_2DLL Serv = new history_2DLL();
        ...
        protected void bing_rep_tmp()
        {
            ...
            var x = Serv.GetRep_HisALL(hddrep_type.Value, Request.QueryString["tprepid"]);
            if (x.Rows.Count != 0)
            {
