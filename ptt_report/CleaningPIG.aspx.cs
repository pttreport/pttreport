...
namespace ptt_report
{
    public partial class CleaningPIG : System.Web.UI.Page
    {
        ...
        protected void btnDEl1_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hddpigresultid = (HiddenField)row.FindControl("hddpigresultid");

            Serv.Deletetblcleaningpig_sub_pigresult(hddpigresultid.Value);
        ...
        protected void btnDEl2_Click(object sender, EventArgs e)
        {
            Button btn = sender as Button;
            GridViewRow row = (GridViewRow)btn.NamingContainer;
            HiddenField hddreplanid = (HiddenField)row.FindControl("hddreplanid");

            Serv.Deletetblcleaningpig_sub_replan(hddreplanid.Value);
