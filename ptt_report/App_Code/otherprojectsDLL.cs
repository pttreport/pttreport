...
namespace ptt_report.App_Code
{
    public class otherprojectsDLL
    {
        ...
        public DataTable GetExistRep_sub(string op_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
        ...
        public DataTable Inserttblother_projects(string quarter_rep_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tblother_projects(quarter_rep_id) " +
                    " values('" +
        ...
        public void Inserttblother_projects_sub(string op_id, string ordernumber, string projectname, string planwork, string workresult, string futureplan, string problem, string opinion)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tblother_project_sub(op_id,ordernumber,projectname,planwork,workresult,futureplan,problem,opinion) " +
                    " values('" +
        ...
        public void Update_tblother_projects_sub(string projectname, string planwork, string workresult, string futureplan, string problem, string opinion, string id, string update_id, string quarter_rep_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Update tblother_project_sub set projectname = '" + projectname + "', planwork = '" + planwork + "'," +
                " workresult = '" + workresult + "',futureplan = '" + futureplan + "',problem = '" + problem + "', " +
        ...
        public void UpdateStatus_rep(string mas_rep_id, string update_id)
        {
            ...
            strSQL = "  update tblquarter_rep set  other_pro = 'Approve',update_date = getdate(),update_id = '" + update_id + "' where id = '" + mas_rep_id + "';  " +
        ...
        public DataTable GetExistRep0_(string master_rep_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
