...
namespace ptt_report.App_Code
{
    public class rbiDLL
    {
        ...
        public void Updatetblrbi_check(string quarter_rep_id, string cplanwork, string cprogressresult, string cfutureplan, string cproblem, string copinion, string id, string update_id)
        {
            ...
            strSQL = " update tblrbi set " +
                ...
                " where quarter_rep_id = '" + quarter_rep_id + "' and id = '" + id + "'; " +
                    ...
                    " update tblquarter_rep set status = 'In Process', offshore = 'In Process',update_date = getdate(),update_id = '"
                    + update_id +
        ...
        public void UpdateStatus_rep(string mas_rep_id, string update_id)
        {
            ...
            strSQL = "  update tblquarter_rep set  offshore = 'Approve',update_date = getdate(),update_id = '" + update_id + "' where id = '" + mas_rep_id + "';  " +
