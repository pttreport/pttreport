...
namespace ptt_report.App_Code
{
    public class pipingDLL
    {
        ...
        public DataTable Insert_tbl_piping(string quarter_rep_id, string opinion)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tbl_piping(quarter_rep_id,opinion) " +
                    " values('" + quarter_rep_id + "', '" + opinion + "') ; select @@IDENTITY as id;  ";
        ...
        public void Update_tbl_piping(string opinion, string id,string update_id,string quarter_rep_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Update tbl_piping set opinion = '" + opinion + "' where id = '" + id + "' ;  " +

                " update tblquarter_rep set status = 'In Process', piping = 'In Process', update_date = getdate(), update_id = '"
                    + update_id +
        ...
        public void UpdateStatus_rep(string mas_rep_id, string update_id)
        {
            ...
            strSQL = "  update tblquarter_rep set  piping = 'Approve',update_date = getdate(),update_id = '" + update_id + "' where id = '" + mas_rep_id + "';  " +
        ...
        public void Insert_tbl_piping_qurter_plan1(string pipg_id, string l1, string l2, string l3, string l4, string type)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tbl_piping_qurter_plan1(pipg_id,l1,l2,l3,l4,type) " +
                        "  values('" + pipg_id + "', '" + l1 + "', '" + l2 + "', '" + l3 + "', '" + l4 + "', '" + type + "') ";
        ...
        public void Insert_tbl_piping_qurter_plan2(string pipg_id, string l30, string l31, string l32, string l33, string type)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tbl_piping_qurter_plan2(pipg_id,l30,l31,l32,l33,type) " +
                        " values('" + pipg_id + "', '" + l30 + "', '" + l31 + "', '" + l32 + "', '" + l33 + "', '" + type + "') ";
        ...
        public void Truncate_tbl_piping_qurter_plan()
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " truncate table tbl_piping_qurter_plan2;  truncate table tbl_piping_qurter_plan1;  ";
        ...
        public void Truncate_tbl_piping_sub()
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " truncate table tbl_piping_sub1 ; " +
                 " truncate table tbl_piping_sub2 ; " +
                  " truncate table tbl_piping_sub3 ; " +
                   " truncate table tbl_piping_sub4 ; " +
                    " truncate table tbl_piping_sub5 ; " +
                     " truncate table tbl_piping_sub6 ;  ";
        ...
        public void Insert_tbl_piping_sub1(string pipg_id, string l5, string l6, string l7, string l8, string l9)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub1(pipg_id,l5,l6,l7,l8,l9) " +
                    " values('" + pipg_id + "', '" + l5 + "', '" + l6 + "', '" + l7 + "', '" + l8 + "', '" + l9 + "')  ";
        ...
        public void Update_tbl_piping_sub1(string l5, string l6, string l7, string l8, string l9, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub1 set "
                + " l5 = '" + l5 + "', "
                + " l6 = '" + l6 + "', "
                + " l7 = '" + l7 + "', "
                + " l8 = '" + l8 + "', "
        ...
        public void Update_tbl_piping_sub2(string l10, string l11, string l12, string l13, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub2 set "
                + " l10 = '" + l10 + "', "
                + " l11 = '" + l11 + "', "
                + " l12 = '" + l12 + "', "
                + " l13 = '" + l13 + "' "
        ...
        public void Update_tbl_piping_sub3(string l14, string l15, string l16, string l17, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub3 set "
                + " l14 = '" + l14 + "', "
                + " l15 = '" + l15 + "', "
                + " l16 = '" + l16 + "', "
                + " l17 = '" + l17 + "' "
        ...
        public void Update_tbl_piping_sub4(string l18, string l19, string l20, string l21, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub4 set "
                + " l18 = '" + l18 + "', "
                + " l19 = '" + l19 + "', "
                + " l20 = '" + l20 + "', "
                + " l21 = '" + l21 + "' "
        ...
        public void Update_tbl_piping_sub5(string l22, string l23, string l24, string l25, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub5 set "
                + " l22 = '" + l22 + "', "
                + " l23 = '" + l23 + "', "
                + " l24 = '" + l24 + "', "
                + " l25 = '" + l25 + "' "
        ...
        public void Update_tbl_piping_sub6(string l26, string l27, string l28, string l29, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tbl_piping_sub6 set "
                + " l26 = '" + l26 + "', "
                + " l27 = '" + l27 + "', "
                + " l28 = '" + l28 + "', "
                + " l29 = '" + l29 + "' "
        ...
        public void Insert_tbl_piping_sub2(string pipg_id, string l10, string l11, string l12, string l13)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub2(pipg_id,l10,l11,l12,l13) " +
                " values('" + pipg_id + "', '" + l10 + "', '" + l11 + "', '" + l12 + "', '" + l13 + "')  ";
        ...
        public void Insert_tbl_piping_sub3(string pipg_id, string l14, string l15, string l16, string l17)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub3(pipg_id,l14,l15,l16,l17) " +
                    " values('" + pipg_id + "','" + l14 + "','" + l15 + "','" + l16 + "','" + l17 + "')  ";
        ...
        public void Insert_tbl_piping_sub4(string pipg_id, string l18, string l19, string l20, string l21)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub4(pipg_id,l18,l19,l20,l21) " +
                        " values('" + pipg_id + "','" + l18 + "','" + l19 + "','" + l20 + "','" + l21 + "') ";
        ...
        public void Insert_tbl_piping_sub5(string pipg_id, string l22, string l23, string l24, string l25)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub5(pipg_id,l22,l23,l24,l25) " +
                    " values('" + pipg_id + "','" + l22 + "','" + l23 + "','" + l24 + "','" + l25 + "') ";
        ...
        public void Insert_tbl_piping_sub6(string pipg_id, string l26, string l27, string l28, string l29)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tbl_piping_sub6(pipg_id,l26,l27,l28,l29) " +
                        " values('" + pipg_id + "','" + l26 + "','" + l27 + "','" + l28 + "','" + l29 + "') ";
        ...
        public DataTable GetSub1(string piping_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " select * from tbl_piping_sub1 where pipg_id = '" + piping_id + "' ";
        ...
        public DataTable GetSub2(string piping_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " select * from tbl_piping_sub2 where pipg_id = '" + piping_id + "' ";
        ...
        public DataTable GetSub3(string piping_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " select * from tbl_piping_sub3 where pipg_id = '" + piping_id + "' ";
        ...
        public DataTable GetSub4(string piping_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " select * from tbl_piping_sub4 where pipg_id = '" + piping_id + "' ";
        ...
        public DataTable GetSub5(string piping_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " select * from tbl_piping_sub5 where pipg_id = '" + piping_id + "' ";
        ...
        public void Deletetbl_piping_sub1(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub1 where id = '" + id + "' ";
        ...
        public void Deletetbl_piping_sub2(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub2 where id = '" + id + "' ";
        ...
        public void Deletetbl_piping_sub3(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub3 where id = '" + id + "' ";
        ...
        public void Deletetbl_piping_sub4(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub4 where id = '" + id + "' ";
        ...
        public void Deletetbl_piping_sub5(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub5 where id = '" + id + "' ";
        ...
        public void Deletetbl_piping_sub6(string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " delete tbl_piping_sub6 where id = '" + id + "' ";
