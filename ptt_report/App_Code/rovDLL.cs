...
namespace ptt_report.App_Code
{
    public class rovDLL
    {
        ...
        public DataTable Inserttblrov(string quarter_rep_id, string planwork, string workresult, string planworkfuture, string problem, string opinion)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " insert into tblrov(quarter_rep_id,planwork,workresult,planworkfuture,problem,opinion) " +
                    " values('" +
        ...
        public void Updatetblrov(string quarter_rep_id, string planwork, string workresult, string planworkfuture, string problem, string opinion, string id, string update_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tblrov set planwork = '" + planwork +
