...
namespace ptt_report.App_Code
{
    public class directassessmentDLL
    {
            ...
            string dainfo22, string dainfo23, string dainfo24, string dainfo25, string dainfo1, string dainfo2, string update_by, string id, string update_id, string mas_rep_id)
        {
            ...
            strSQL = " update tbldirect_assessment set dainfo11 = '" + dainfo11 + "',dainfo12 = '" + dainfo12 + "', " +
             " dainfo13 = '" + dainfo13 + "',dainfo14 = '" + dainfo14 + "', " +
             " dainfo21 = '" + dainfo21 + "',dainfo22 = '" + dainfo22 + "', " +
             " dainfo23 = '" + dainfo23 + "',dainfo24 = '" + dainfo24 + "', " +
             " dainfo25 = '" + dainfo25 + "', dainfo1 = '" + dainfo1 + "', " +
             " dainfo2 = '" + dainfo2 + "',update_by = '" + update_by + "' " +
             " where id = '" + id + "' and quarter_rep_id = '" + quarter_rep_id + "' ; " +

             "  update tblquarter_rep set status = 'In Process', pm_cm_status = 'In Process',update_date = getdate()," +
             " update_id = '" + update_id + "' where id = '" + mas_rep_id + "';   ";
        ...
        public void UpdateHistory(string version, string filename, string id, string quarter_red_id)
        {
            ...
            strSQL = " Update tbl_history_rep set version = '" + version + "',filename = '" + filename + "', quarter_rep_id = '" + quarter_red_id + "'" +
                    " where id = '" + id + "' ";
