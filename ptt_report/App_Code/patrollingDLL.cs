...
namespace ptt_report.App_Code
{
    public class patrollingDLL
    {
        ...
        public DataTable InsertFirst_patoll(string quarter_rep_id, string groung_img_uri, string groung_img_path, string aerial_result,
            string remark1, string problem, string remark2, string update_by, string status, string update_date)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " Insert into tblpatrolling(quarter_rep_id,groung_img_uri,groung_img_path,aerial_result,remark1,problem,remark2,update_by,status,update_date) " +
                        " values('" + quarter_rep_id + "', '" + groung_img_uri + "', '" + groung_img_path + "', '" + aerial_result + "', '" + remark1 + "', '" + problem + "', '" + remark2 + "', " +
                        " '" + update_by + "', '" + status + "','" + update_date + "'); select @@IDENTITY as id; ";
        ...
        public void Update_File(string groung_img_uri, string groung_img_path, string id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tblpatrolling set groung_img_uri = '" + groung_img_uri + "',groung_img_path = '" + groung_img_path + "' where id = '" + id + "'  ";
        ...
        public void Update_info(string aerial_result, string remark1, string problem, string remark2, string update_by, string id,string update_id,string mas_rep_id)
        {
            SqlConnection objConn = new SqlConnection();
            SqlCommand objCmd = new SqlCommand();
            SqlDataAdapter dtAdapter = new SqlDataAdapter();
            ...
            strSQL = " update tblpatrolling set aerial_result = '" + aerial_result + "',remark1 = '" + remark1 + "',problem='" + problem + "',remark2='" + remark2 + "', " +
                    " update_by = '" + update_by + "' where id = '" + id + "' ; "+
